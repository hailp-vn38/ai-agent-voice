...
> Supersession note: ADR-0045 bổ sung urgent lane và GenerationGate cho mọi turn payload trong interruption path. Single Writer và scheduling control/audio của ADR này vẫn Accepted.
